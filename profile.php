                                ...
                                if ($user_result) {
                                    ...
                                    if ($tickets_result) {
                                        ...
                                        while ($ticket_data = pg_fetch_assoc($tickets_result)) {
                                            ...
                                            echo '      <span class="sfo">' . $ticket_data['arrival_city_name'] . '</span>';
                                            echo '      <span class="jfk jfkslip">' . $ticket_data['departure_city_name'] . '</span>';

                                            echo '      <span class="sfo sfoslip">' . $ticket_data['arrival_city_name'] . '</span>';
